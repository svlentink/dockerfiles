...
echo 'Warning this is a test output!'
...
http-01 challenge for ssltest.inbetweencows.nl
...
IMPORTANT NOTES:
 - Congratulations! Your certificate and chain have been saved at
   /etc/letsencrypt/live/$1/fullchain.pem. Your
   cert will expire on 2017-07-18. To obtain a new or tweaked version
...
lets_path="/etc/letsencrypt/live/"$1
mkdir -p $lets_path

cat <<EOF > $lets_path/cert.pem
-----BEGIN CERTIFICATE-----
testfile
certificate
publickey
...
cat $lets_path/cert.pem >> $lets_path/fullchain.pem
cat $lets_path/chain.pem >> $lets_path/fullchain.pem
